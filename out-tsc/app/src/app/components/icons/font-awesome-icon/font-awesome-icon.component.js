...
var FontAwesomeIconComponent = /** @class */ (function () {
    ...
    //Display Icon detail
    FontAwesomeIconComponent.prototype.toggleWithInfo = function (icon) {
        this.detail = true;
        this.icon = icon;
        this.val = '<i class="fa fa-' + icon + '"></i>';
    };
    //Copy an icon code
    FontAwesomeIconComponent.prototype.copyText = function (val) {
    ...
    FontAwesomeIconComponent.prototype.ngOnInit = function () { };
    FontAwesomeIconComponent = __decorate([
        Component({
...
export { FontAwesomeIconComponent };
//# sourceMappingURL=font-awesome-icon.component.js.map