...
var FlagIconComponent = /** @class */ (function () {
    ...
    //Display Icon detail
    FlagIconComponent.prototype.toggleWithInfo = function (icon) {
        this.detail = true;
        this.flag = icon;
        this.val = '<i class="flag-icon flag-icon-' + icon + '"></i>';
    };
    //Copy an icon code
    FlagIconComponent.prototype.copyText = function (val) {
    ...
    FlagIconComponent.prototype.ngOnInit = function () { };
    FlagIconComponent = __decorate([
        Component({
...
//# sourceMappingURL=flag-icon.component.js.map