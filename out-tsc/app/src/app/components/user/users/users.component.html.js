...
"btn btn-primary ml-2"[routerLink] = "['/user/new-user']" > ADD < /i></button >
    /div>
    < /div>
    < /div>
    < /div>
...
/h6>
    ...
    {};
{
    item.payload.doc.data().password;
}
/h6>
    < /td>
    < td > /** @class */ (function () {
...
"btn btn-primary mr-2"[routerLink] = "['/user/edit-user',item.payload.doc.id]" > Edit < /a>
    < button;
...
Ends-- >
;
//# sourceMappingURL=users.component.html.js.map