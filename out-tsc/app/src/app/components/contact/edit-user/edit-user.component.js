...
var EditUserComponent = /** @class */ (function () {
    function EditUserComponent(fb, route, router, contactService, toastr) {
        this.fb = fb;
        this.route = route;
        this.router = router;
    ...
    EditUserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [FormBuilder, ActivatedRoute, Router, ContactService, ToastrService])
    ], EditUserComponent);
