...
"task"[ngClass] = "{'completed':todo.completed}" * ngFor;
"let todo of todos;let i=index" >
    /** @class */ (function () {
        function class_21() {
        }
        return class_21;
...
title = "Delete Task"(click) = "taskDeleted(i)" > /** @class */ (function () {
    function class_24() {
    }
    return class_24;
}());
...
placeholder = "Enter new task here. . ."[(ngModel)] = "text"[/** @class */ (function () {
    ...
    return class_32;
}()).border - danger] = "red_border" > /textarea>
    < button;
...
"task" > /span><span class="notification-text"></span > /p>
    ...
    < !--Container - fluid;
Ends-- > ;
//# sourceMappingURL=to-do.component.html.js.map