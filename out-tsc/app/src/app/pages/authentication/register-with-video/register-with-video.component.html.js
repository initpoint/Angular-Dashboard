...
"btn social-btn btn-fb d-inline-block" > /** @class */ (function () {
    function class_24() {
    }
    return class_24;
}());
"fa fa-facebook" > /i></button >
    /** @class */ (function () {
        function class_25() {
        }
        return class_25;
    }());
"btn social-btn btn-twitter d-inline-block" > /** @class */ (function () {
    function class_26() {
    }
    return class_26;
}());
"fa fa-google" > /i></button >
    /** @class */ (function () {
        function class_27() {
        }
        return class_27;
    }());
"btn social-btn btn-google d-inline-block" > /** @class */ (function () {
    function class_28() {
    }
    return class_28;
}());
"fa fa-twitter" > /i></button >
    /** @class */ (function () {
        function class_29() {
        }
        return class_29;
    }());
"btn social-btn btn-github d-inline-block" > /** @class */ (function () {
    function class_30() {
    }
    return class_30;
}());
"fa fa-github" > /i></button >
    /div>
    < /div>
    < /form>
    < /div>
...
ends-- >
    /div>;
//# sourceMappingURL=register-with-video.component.html.js.map