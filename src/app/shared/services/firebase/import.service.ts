...
export class ImportService {
    ...
    promotionStructure = [
        ...
        {field: 'conditionMaterialType', text: 'نوع المادة'},
        {field: 'conditionUnitCode', text: 'الوحدة -الرمز', defaultValueField: 'AL'},
        {field: 'conditionUnitName', text: 'الوحدة -الاسم', defaultValueField: 'AM'},
        ...
        {field: 'materialDiscountAmount', text: 'المبلغ', defaultValueField: 'AT'},
        {field: 'materialDiscountPercentage', text: '%', defaultValueField: 'AU'},
        {field: 'materialDiscountType', text: 'نوع القيمة'},
        ...
        {field: 'freeItemUnitCode', text: 'الوحدة -الرمز', defaultValueField: 'AY'},
        {field: 'freeItemUnitName', text: 'الوحدة -الاسم', defaultValueField: 'AZ'},
        {field: 'freeItemAmount', text: 'الكمية'},
        {field: 'customerCode', text: 'رمز العميل'},
        {field: 'customerName', text: 'اسم العميل / مجموعه'},
    ];
    billStructure = [
        {field: 'code', text: 'التركيبة  -الرمز'},
        {field: 'nameArFull', text: 'التركيبة  -الاسم'},
